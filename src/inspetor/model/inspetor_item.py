...
class InspetorItem(InspetorAbstractModel):
    ...
    def is_valid(self):
        ...
        if not self.session_ids or not isinstance(self.session_ids, list) :
            raise InspetorItemException(
                InspetorItemException.REQUIRED_ITEM_SESSION_IDS
            )
    ...
    def jsonSerialize(self):
        return {
            ...
            "item_session_ids"    : self.encode_data(self.session_ids),
